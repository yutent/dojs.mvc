...
class Dojs {
    ...
    constructor(basedir){
        ...
        global.Fs = require('./fs') //注册fs文件操作类
    ...
    //注册路由，启动框架
    static run(){
        Response._set('X-Powered-By', 'doJS');
...
/*--------------------------------------------------------------------------------*/
    ...
    start(){
        ...
        http.createServer((req, res) => {
            ...
            global.Response = new (require('./response'))(res)
            global.Request = new (require('./request'))(req)
