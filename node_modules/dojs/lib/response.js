...
class Response {
    ...
    rander(data){
        ...
        this._set('Content-Type', 'text/html')
        this._set('Content-Length', Buffer.byteLength(data))
        this.res.end(data)
    }
    ...
    send(code, msg, data, callback){
        ...
        this._set('Content-Type', 'application/json')
        this._set('Content-Length', Buffer.byteLength(output))
        if(callback){
